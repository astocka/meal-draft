...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "pain category"
      decision: "triple-hit: decision paralysis + food waste + skill gap"
    - topic: "persona scope"
      decision: "busy working adults who cook at home"
    - topic: "product insight"
      decision: "one answer at a time with hard-constraint enforcement + Try another excludes past results"
    - topic: "auth strategy"
      decision: "email + password; flat user model, no roles"
    - topic: "MVP scope cuts"
      decision: "cut Minimum Missing strategy and equipment filtering for v1; keep favorites + history"
    - topic: "timeline"
      decision: "3 weeks after-hours, hard deadline 2026-07-05"
    - topic: "product type"
      decision: "web-app, responsive, small user scale (personal — family & friends)"
    - topic: "non-goals"
      decision: "7 explicit non-goals: no meal planning, no calories, no shop integration, no auto-deduction, no mobile app, no social, no offline"
  frs_drafted: 13
...
- Continuous visible feedback (progress indicator) during any operation that takes longer than 1 second.
...
- **No offline-first guarantee.** Meal generation requires an AI service call — internet connectivity is assumed. Offline caching is not a v1 goal.

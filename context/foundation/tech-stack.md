...
## As built (MVP v1 complete, 2026-07-02)
...
- **Try another (S-04):** session `exclude_names`, **Inny przepis**, exhaustion panel; Polish copy in `generation-copy.ts`
- **Favorites (S-05):** save/unsave star on generator; `/favorites` + `FavoritesShell`; **Ulubione** in topbar
- **Tests / CI:** three-tier GitHub Actions (lint+build, Vitest RLS, Playwright E2E on workerd preview) — see @context/foundation/test-plan.md

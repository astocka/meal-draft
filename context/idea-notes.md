> **SUPERSEDED** — Te notatki to wczesna wizja produktu sprzed shaping session. Wiele opisanych funkcji (wyposażenie kuchni, Minimum Missing, historia UI) zostało wyciętych w `context/foundation/shape-notes.md` i `prd.md`. Aktualna specyfikacja: `context/foundation/prd.md`. Nie cytować jako specyfikacji.

...
| **Podstawy kuchenne / Cooking staples**       | Składniki uniwersalne (sól, olej, mąka…) dozwolone w przepisie mimo braku wpisu w spiżarni                        | Plan F-02: `context/archive/2026-06-01-ai-meal-generation/plan-brief.md:35` — „Soft — server-side staples allowlist” | `COOKING_STAPLES` `src/lib/generation.ts:9-31`; walidacja `generation.ts:238-241`                                                                            |
...
| **Niezmiennik**      | Przy `no_match` brak udanego przepisu dla klienta; bez insertu sukcesu do historii                                                  | Plan F-02 `context/archive/2026-06-01-ai-meal-generation/plan-brief.md:25`; kod `generation.ts:216-223` (early return bez insert) |
| **Status egzekucji** | **Egzekwuje**                                                                                                                       |
| **Niezmiennik**      | Pusta spiżarnia → natychmiastowy `no_match` (bez LLM)                                                                               | Plan F-02 `context/archive/2026-06-01-ai-meal-generation/plan-brief.md:40`; kod `generation.ts:161-168`                           |
| **Status egzekucji** | **Egzekwuje**                                                                                                                       |
